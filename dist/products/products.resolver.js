...
const get_products_args_1 = require("./dto/get-products.args");
const get_product_args_1 = require("./dto/get-product.args");
const get_popular_products_args_1 = require("./dto/get-popular-products.args");
let ProductsResolver = class ProductsResolver {
    ...
    async getProducts(getProductsArgs) {
    ...
    async getPopularProducts(getPopularProductsArgs) {
    ...
    async related_products(product, limit) {
        const { type } = product;
...
__decorate([
    (0, graphql_1.Query)(() => get_products_args_1.ProductPaginator, { name: 'products' }),
    __param(0, (0, graphql_1.Args)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [get_products_args_1.GetProductsArgs]),
...
__decorate([
    ...
    __param(0, (0, graphql_1.Args)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [get_product_args_1.GetProductArgs]),
    __metadata("design:returntype", Promise)
], ProductsResolver.prototype, "getProduct", null);
__decorate([
    (0, graphql_1.Query)(() => [product_entity_1.Product], { name: 'popularProducts' }),
    __param(0, (0, graphql_1.Args)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [get_popular_products_args_1.GetPopularProductsArgs]),
    __metadata("design:returntype", Promise)
], ProductsResolver.prototype, "getPopularProducts", null);
__decorate([
    (0, graphql_1.Mutation)(() => product_entity_1.Product),
    __param(0, (0, graphql_1.Args)('input')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [product_entity_1.Product, Number]),
    __metadata("design:returntype", Promise)
], ProductsResolver.prototype, "related_products", null);
